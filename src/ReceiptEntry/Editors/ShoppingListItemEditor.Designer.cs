...
{
  partial class ShoppingListItemEditor
  {
    /// <summary> 
    ...
    private void InitializeComponent()
    {
      ...
      this.cboAlias.Properties.NullText = "[Select a shopping list item]";
      ...
      this.chkEnableAlias.Properties.Caption = "I want to tag a shopping list item";
      ...
      this.Name = "ShoppingListItemEditor";
