namespace ReceiptEntry.DExpress
{
  partial class MainForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.gridViewReceipts.OptionsView.ShowFooter = true;
      ...
      this.gridViewReceipts.CustomDrawFooterCell += new DevExpress.XtraGrid.Views.Grid.FooterCellCustomDrawEventHandler(this.gridViewReceipts_CustomDrawFooterCell);
      this.gridViewReceipts.GroupRowExpanded += new DevExpress.XtraGrid.Views.Base.RowEventHandler(this.gridViewReceipts_GroupRowExpanded);
      ...
      this.tbbSearchText.EditValueChanged += new System.EventHandler(this.tbbSearchText_EditValueChanged);
      // 
      // txtSearchText
      // 
      ...
      this.tbbMerchantFilter.EditValueChanged += new System.EventHandler(this.tbbMerchantFilter_EditValueChanged);
      // 
      // cboMerchantFilter
      // 
